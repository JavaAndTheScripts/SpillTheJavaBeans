...
<html>
	...
	<body>
		...
		<header class="navHead">
			...
			<h1>
				<a class="title" href="/cafe" style="text-decoration: none"
					>${cafe.name}</a
				>
			</h1>
			<div>
		...
		<main>
			...
			>
				...
				<div class="py-2">
					<section>
						<form:label path="email" class="border-end w-50 ps-2 me-1"
							>Email</form:label
						>
				...
				<div class="py-2">
					<section>
						<form:label path="password" class="border-end w-50 ps-2 me-1"
							>Password</form:label
						>
				...
				<div class="pb-3">
					<button class="btn btn-dark my-1 w-100">Login</button>
				</div>
			</form:form>
			</div>
			</div>

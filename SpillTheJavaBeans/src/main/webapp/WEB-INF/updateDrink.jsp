...
<body>
    ...
    <main class="m-3">
        <div class="container" style="background-color: rgba(131, 85, 44, 0.753);">
            <h2 class="text-center">Update a Drink</h2>
            <form:form action="/drink/${drink.id}/updateDrink" method="post" modelAttribute="updateForm" class="mx-5 my-2">
                ...
                <div class="my-2">
                    ...
                    <input type="text" name="ingredients" value="${ drink.ingredients }" class="form-control">
                    <!-- Validation Error -->
                ...
                <div class="d-flex flex-row align-items-center my-2">
                    ...
                    <div class="mb-3 ">
                        ...
                        <input type="number" step=".01" name="bytePrice" value="${ drink.bytePrice }" class="form-control">
                        <!-- Validation Error -->
                        <form:errors path="bytePrice" class="text-warning ms-2"/>
                    </div>
                    <div class="mb-3 ">
                        <label for="intPrice">Integer</label>
                        <input type="number" step=".01" name="intPrice" value="${ drink.intPrice }" class="form-control">
                        <!-- Validation Error -->
                        <form:errors path="intPrice" class="text-warning"/>
                    </div>
                    <div class="mb-3 ">
                        <label for="longPrice">Long</label>
                        <input type="number" step=".01" name="longPrice" value="${ drink.longPrice }" class="form-control">
                        <!-- Validation Error -->
                ...
                <!-- Submission button -->
                <div class=""><button class="btn btn-dark">Update Drink</button></div>
            </form:form>
        </div>
    </main>
    <!-- FOOTER -->

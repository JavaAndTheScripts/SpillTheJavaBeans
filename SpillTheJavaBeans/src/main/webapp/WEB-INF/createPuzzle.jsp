...
<body>
    ...
    <main class="m-3">
        <div class="container">
        <div class="p-4" style="background-color: rgba(131, 85, 44, 0.753);">
            <h2 class="text-center">Monthly Puzzle</h2>
            <!-- FORM -->
            <form:form action="/puzzle/create" method="post" modelAttribute="modelForm" class="mx-5 my-2">
                <!-- Cafe cafe -->
                ...
                <div class=" mb-3">
                    ...
                    <input type="number" step="1" name="percent" class="form-control">
                </div>
                <!-- Validation Error -->

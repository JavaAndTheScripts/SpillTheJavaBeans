					...
					<tbody class="">
						<c:forEach items="${allDrinks}" var="d">
							<tr>
								...
								<td>
									<fmt:formatNumber value="${d.bytePrice}" type="currency" />
								</td>
								<!-- Drink price - int (medium) -->
								<td>
									<fmt:formatNumber value="${d.intPrice}" type="currency" />
								</td>
								<!-- Drink price - Long (Large) -->
								<td>
									<fmt:formatNumber value="${d.longPrice}" type="currency" />
								</td>
							</tr>
						</c:forEach>
					</tbody>
